...
public class EonSprings extends Map{
    public EonSprings() {
        this.mapArray = new int[][]{
                {1, 0, 0, 0, 1, 4, 4, 4, 4, 4 ,4 ,4 ,4 ,4 ,4 ,4 ,4 ,0 ,1},
                {0, 0, 0, 0, 3, 3, 2, 1, 0, 0 ,0 ,0 ,0 ,0 ,0 ,0 ,4 ,6 ,0},
                ...
                {0, 0, 0, 0, 1, 3, 3, 4, 4, 3 ,3 ,3 ,3 ,1 ,0 ,0 ,4 ,0 ,0},
                {0, 0, 0, 0, 0, 3, 4, 4, 3, 3 ,3 ,3 ,3 ,1 ,0 ,1 ,4 ,0 ,1},
                {0, 0, 4, 4, 4, 4, 4, 3, 3, 3 ,3 ,3 ,4 ,4 ,4 ,4 ,4 ,0 ,0},
                {0, 2, 4, 0, 1, 1, 3, 3, 3, 3 ,3 ,4 ,4 ,3 ,1 ,0 ,0 ,0 ,0},
                {0, 0, 4, 0, 0, 1, 3, 3, 3, 3 ,4 ,4 ,3 ,3 ,1 ,0 ,0 ,0 ,0},
                ...
                {1, 5, 4, 0, 0, 0, 1, 1, 0, 0 ,0 ,0 ,1 ,3 ,3 ,0 ,0 ,0 ,0},
                {1, 0, 4, 4, 4, 4, 4, 4, 4, 4 ,4 ,4 ,4 ,4 ,1 ,0 ,0 ,0 ,1}
        };
    }
